...
$sql = "SELECT u.id, u.username, u.email, u.phone_number, u.balance, u.created_at, u.is_admin, u.is_email_verified, u.api_access_status, r.username as referrer_username, u.profit_percentage
        FROM users u
